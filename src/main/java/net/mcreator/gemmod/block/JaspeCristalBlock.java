...
public class JaspeCristalBlock extends GemModModElements.ModElement {
	@ObjectHolder("gem_mod:jaspe_cristal")
	public static final Block block = null;
	public JaspeCristalBlock(GemModModElements instance) {
		super(instance, 62);
	}
