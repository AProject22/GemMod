...
public class SafiraItem extends GemModModElements.ModElement {
	@ObjectHolder("gem_mod:safira")
	public static final Item block = null;
	public SafiraItem(GemModModElements instance) {
		super(instance, 26);
	}
